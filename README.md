...
# cs100-F2018-practical3-starter

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the starter for Practical 3 in Computer Science 100. Since
...
It will display a graphical scene, with complementary colors, that meets the
...
Chapter 3 in the course textbook, paying close attention to Sections 3.9
through 3.11. Please see the course instructor or one of the teaching
...
output that may differ from the instructor's version of
...
your version may produce slightly different graphical output.
...
* practicalthree/DisplayComplementaryDrawingCanvas.java:
  ...
  * Features at least ten multiple-line comments
  * Constructs and displays exactly two `Rectangle` objects
  * Contains three references to the fragment `HORIZONTAL_ORIGIN`
  * Contains two references to the fragment `VERTICAL_ORIGIN`
  * Contains four references to the fragment `CANVAS_HEIGHT`
  * Contains five references to the fragment `CANVAS_WIDTH`
  * Displays a canvas with the label `A Complementary Graphical Scene`
...
```
git remote add download git@github.com:allegheny-computer-science-100-F2018/cs100-F2018-practical3-starter.git
```
...
Starter](https://github.com/Allegheny-Computer-Science-100-F2018/cs100-F2018-practical3-starter)
